const AboutComp2 = () => {
    return (
      <div className="about-container p-8">
        <h2 className="text-4xl lg:text-5xl font-mono font-bold text-center mb-5 mt-4 p-3 mb-2">About Psychopharmacologist</h2>
        <p className="mb-4 text-lg lg:text-2xl font-serif">
